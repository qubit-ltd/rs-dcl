...
# Create list of other workspace crates to exclude (any sibling directory with Cargo.toml)
OTHER_CRATES=""
...
# Ensure the output directory exists for file-based report formats.
